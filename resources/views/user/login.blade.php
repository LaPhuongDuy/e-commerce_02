        ...
        <div class="main container">
            <div class="account-login">
                <div class="page-title">
                    <h2>{{ trans('user/label.title_login') }}</h2>
                </div>
                <fieldset class="col2-set">
                    <legend>{{ trans('user/label.title_login') }}</legend>
                    <div class="col-1 new-users"><strong>{{ trans('user/label.new_customer') }}</strong>
                        <div class="content">
                            <p>{{ trans('user/label.content_login') }}</p>
                            <div class="buttons-set">
                                <button onclick="window.location='{{ url('/register') }}';"
                                        class="button create-account" type="button">
                                    <span>{{ trans('user/label.create_account') }}</span>
                                </button>
                            </div>
                        </div>
                    </div>
                    {!! Form::open(['route' => 'login']) !!}
                        <div class="col-2 registered-users"><strong>{{ trans('user/label.register_customer') }}</strong>
                            <div class="content">
                                ...
                                <ul class="form-list">
                                    <li>
                                        ...
                                        <input type="text" title="Email Address" class="input-text required-entry"
                                               id="email" value="{{ old('email') }}" name="email" required autofocus>
                                        @if ($errors->has('email'))
                                ...
                                <div class="buttons-set">
                                    ...
                                    <a class="forgot-word">{{ trans('user/label.forgot_pass') }}</a>
                                </div>
                            </div>
                        </div>
                    {!! Form::close() !!}
