                                            ...
                                            <div class="pull-left">
                                                <div class="custom pull-left">
                                                    ...
                                                    <button onClick="var result = document.getElementById('qty');
                                                        ...
                                                        result.value--;return false;" class="reduced items-count" type="button">
                                                        <i class="icon-minus">&nbsp;</i>
                                                    </button>
                                                </div>
                                            </div>
                                            <button onClick="productAddToCartForm.submit(this)" class="button btn-cart"
                                                title="Add to Cart" type="button"><span>
                                                <i class="icon-basket"></i> Add to Cart</span>
                                            </button>
                                        </div>
                                        <div class="email-addto-box">
                                            <ul class="add-to-links">
                                                ...
                                                <li><span class="separator">|</span> <a class="link-compare"
                                                    href="#"><span>{{ trans('user/label.add_compare') }}</span></a>
                                                </li>
                                            </ul>
                                            <p class="email-friend"><a href="#" class="">
                                                <span>{{ trans('user/label.email_to_friend') }}</span></a>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="custom-box">
                                        <img alt="banner" src="{{ url($product->brand->url) }}">
                                    </div>
                                </div>
                            </form>
                        </div>
                                ...
                                <ul id="product-detail-tab" class="nav nav-tabs product-tabs">
                                    <li class="active">
                                        <a href="#product_tabs_description" data-toggle="tab">
                                            {{ trans('user/label.product_description') }}
                                        </a>
                                    </li>
                                    @if(auth::check())
                                        <li>
                                            <a href="#product_tabs_tags" data-toggle="tab">
                                                {{ trans('user/label.comments') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#reviews_tabs" data-toggle="tab">
                                                {{ trans('user/label.reviews') }}
                                            </a>
                                        </li>
                                    @endif
                                </ul>
                                                ...
                                                <div class="box-reviews2">
                                                    ...
                                                    <div class="buttons-set">
                                                        <button class="button submit" title="Submit Review" type="submit">
                                                            <span>{{ trans('user/label.submit_comment') }}</span>
                                                        </button>
                                                    </div>
                                                    {!! Form::close() !!}
                                            ...
                                            <div class="box-collateral box-reviews" id="customer-reviews">
                                                <div class="box-reviews1">
                                                    <div class="form-add">
                                                        ...
                                                        @if(!\App\Models\Rating::scoreByCustomer(auth::id(), $product->id))
                                                            <h3>{{ trans('user/label.get_rate') }}</h3>
                                                        @else
                                                            <h3>
                                                                {{ trans('user/label.rated_point') }}
                                                                {{ \App\Models\Rating::scoreByCustomer(auth::id(), $product->id)->score }}
                                                            </h3>
                                                        @endif
                                                        {!! Form::hidden('product_id', $product->id) !!}
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <table id="product-review-table" class="data-table">
                                                                ...
                                                                <tr class="first odd">
                                                                    <th>Score</th>
                                                                    @for($i = 1; $i <= 5; $i++)
                                                                        @if($i == \App\Models\Rating::scoreByCustomer(auth::id(), $product->id)->score)
                                                                ...
                                                                <div class="info">
                                                                    <div class="info-inner">
                                                                        <div class="item-title">
                                                                            <a title=" Sample Product" href="product_detail.html">
                                                                                {{ $item->name }}
                                                                            </a>
                                                                        </div>
                                                                        <!--item-title-->
