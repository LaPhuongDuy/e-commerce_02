                                ...
                                <div class="slider-items slider-width-col4">
                                    ...
                                    @foreach($best_seller as $item)
                                        ...
                                        <div class="col-item">
                                            ...
                                            @endif
                                            <div class="images-container"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img src="{{ url($item->url) }}" class="img-responsive" alt="product-image" /> </a>
                                                <div class="actions">
                                            ...
                                            <div class="info">
                                                <div class="info-inner">
                                                    <div class="item-title"> <a title=" Sample Product" href="{{ action('User\ProductController@show', [$item->id]) }}"> {{ $item->name }} </a> </div>
                                                    <!--item-title-->
                                    ...
                                    @foreach($latest_product as $item)
                                        ...
                                        <div class="col-item">
                                            ...
                                            <div class="info">
                                                ...
                                                <!--info-inner-->
                                                <div class="actions">
                                                    <button class="button btn-cart" title="Add to Cart" type="button"><span>{{ trans('user/label.add_cart') }}</span></button>
                                                </div>
                                                <!--actions-->
                                                <div class="clearfix"> </div>
                                            </div>
